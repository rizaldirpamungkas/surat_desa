...
class _HistoryLetterState extends State<HistoryLetter> {
      ...
      return PopupMenuButton(
        itemBuilder: (context) {
          return [
            ...
            PopupMenuItem(value: "Batalkan", child: Text("Batalkan")),
          ];
        },
        elevation: 4,
        onSelected: (val) {
    ...
    try {
      ...
      if (data != null) {
        if (data.statusCode == 200) {
          ...
          setState(() {
            surats =
                suratRaw.map((suratJson) => Surat.fromJson(suratJson)).toList();
          });
        }
      }
    } catch (e) {
  ...
  void detailLetter(int i, BuildContext context) {
    Surat sur = surats[i];
    print(sur.idSurat);
    Navigator.pushNamed(context, "/home/history_letter/detail_letter",
        arguments: Surat(
            sur.noSurat,
            sur.idSurat,
            sur.idPemohon,
  ...
  void editLetter(int i, BuildContext context) async {
    ...
    var stat = await Navigator.pushNamed(
        context, "/home/history_letter/edit_letter",
        arguments: Surat(
            sur.noSurat,
            sur.idSurat,
            sur.idPemohon,
...
class Surat {
  ...
  factory Surat.fromJson(dynamic json) {
    return Surat(
        ...
        json["id_pemohon"] as String,
        json["id_pencetak"] as String,
        json["pencetak"] as String,
        json["tipe_surat"] as String,
        json["nama"] as String,
        json["pemohon"] as String,
        json["tempat_lahir"] as String,
        json["tanggal_lahir"] as String,
        json["agama"] as String,
        json["kebangsaan"] as String,
        json["status_pernikahan"] as String,
        json["pekerjaan"] as String,
